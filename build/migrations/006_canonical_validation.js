...
async function migrate() {
    ...
    `);
      ...
      `);
            ...
            const target = tables.has('memories')
                ...
                : tables.has('facts')
                    ...
                    : null;
            if (!target) {
                throw new Error("Neither 'facts' nor 'memories' exists. Run setup so the base schema is created before applying migrations.");
            }
      ...
      `);
            ...
            await client.query(`INSERT INTO migration_history (name) VALUES ('v0.5_provenance')

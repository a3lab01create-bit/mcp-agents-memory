...
const MIGRATION_NAME = "023_librarian_gate";
...
async function migrate() {
  ...
  try {
    ...
    try {
      ...
      await client.query(`
        ALTER TABLE users
          ADD COLUMN IF NOT EXISTS librarian_last_run_at     TIMESTAMPTZ,
          ADD COLUMN IF NOT EXISTS librarian_msg_count_at_run BIGINT NOT NULL DEFAULT 0;
      `);
